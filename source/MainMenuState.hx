...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		{
			var menuItem:MenuButton = new MenuButton(optionShit[i], 0, 60 + (i * 160));
			menuItem.ID = i;
		...
		var engineVer:FlxText = new FlxText(5, FlxG.height - 20, 0, "Project Plus v0.1", 12);
		...
		var gameVer:FlxText = new FlxText(5, FlxG.height - 38, 0, "FNF v0.2.7.1", 12);
